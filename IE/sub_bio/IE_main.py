...
from IE_model import SubjectRecModule, SubjectPredictor
...
if __name__ == '__main__':
    ...
    parser.add_argument("--stage", type=str, default="sub", choices=["sub", "bio"], help="train the NER model or not (default: False)")
    parser.add_argument("--batch_size", type=int, default=12, help="input batch size for training and test (default: 8)")
    parser.add_argument("--max_epochs", type=int, default=30, help="the max epochs for training and test (default: 5)")
    parser.add_argument("--lr", type=float, default=2e-5, help="learning rate (default: 2e-5)")
    parser.add_argument("--dropout", type=float, default=0.2, help="dropout (default: 0.2)")
    parser.add_argument("--optimizer", type=str, default="Adam", choices=["Adam", "SGD"], help="optimizer")
    parser.add_argument("--sample", type=utils.str2bool, default=False, help="train the NER model or not (default: False)")
    ...
    parser.add_argument("--schema_path", type=str, default="{}/duie_schema.json".format(DATA_DIR),
                        help="schema_path")
    parser.add_argument("--test_path", type=str, default="{}/duie_test1.json".format(DATA_DIR),
                        help="test_path")
    ...
    parser.add_argument("--test_ckpt_name",  type=str, default="val_f1=0.8073_epoch=24_dropout.ckpt", help="ckpt name for test")
    ...
    if config.is_train == True:
        ...
        trainer = pl.Trainer(
            ...
            resume_from_checkpoint = config.ner_save_path + '/val_f1=0.7968_epoch=23_dropout.ckpt',  # 加载已保存的模型继续训练
        ...
        predictor = SubjectPredictor(checkpoint_path, config)
